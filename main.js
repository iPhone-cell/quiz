...
const questions = [
    {
        question: 'Какая страна с самой большой численностью населения?',
        options: [
            'Китай',
            'Индия',
            'Индонезия',
    ...
    {
        question: 'Когда образовалась компания Apple?',
        options: [
            '9 июня 1976 г',
            '1 апреля 1976 г',
            '11 октября 1978 г',
    ...
    {
        question: 'Какая сборная победила на Чемпионате Европы по футболу 2020?',
        options: [
            'Франция',
            'Бельгия',
            'Англия',
